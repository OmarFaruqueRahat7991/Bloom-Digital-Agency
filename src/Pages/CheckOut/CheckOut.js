...
const CheckOut = () => {
	...
	<form onSubmit={handlePlaceOrder} novalidate="" action="" className="container flex flex-col mx-auto space-y-12 ng-untouched ng-pristine ng-valid">
		...
		<fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
			...
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				...
				<div className="col-span-full sm:col-span-3">
					<label for="phone" className="text-xl">Phone Number</label>
					<input id="phone" type="phone" name='phone'  className="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 dark:border-gray-700 dark:text-gray-900 h-16" />
				</div>
